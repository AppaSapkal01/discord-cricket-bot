...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName("stats-alltime")
        .setDescription("Get alltime player stats")
    ...
    async execute(interaction) {
        ...
        const ITEMS_PER_PAGE = 3; // Show 3 players per page
        const totalPages = Math.ceil(playersToShow.length / ITEMS_PER_PAGE);

        // Generate message in your exact format (without Balls)
...
🏏 T20 Stats:
• Batting: Matches: ${stats.batting.matches}, Runs: ${stats.batting.runs}, SR: ${stats.batting.strikeRate}, Avg: ${stats.batting.average}
