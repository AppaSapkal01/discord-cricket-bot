// commands/stats-alltime.js (updated)
...
`;
        ...
        collector.on('collect', async (buttonInteraction) => {
            if (buttonInteraction.user.id !== interaction.user.id) {
                return buttonInteraction.reply({ content: "❌ Only you can use these buttons!", ephemeral: true });
            }
        ...
        collector.on('end', () => {
            if (!message.deleted) message.edit({ components: [] }).catch(() => {});
        });
    }
};